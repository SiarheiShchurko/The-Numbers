...
class Game{
    ...
    var itemArray:[Item] = [] ///Создаем пустой массив в который будут попадать 16 рандомных чисел из массива data. Этот массив не private т.к. мы обращаемся к нему из GameViewController и если мы оставим private - обратиться к нему не сможем.
